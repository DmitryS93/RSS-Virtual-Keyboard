...
//1
let Digit1 = document.getElementById("Digit1Id");
Digit1.innerHTML = `${keysArray[1][arrayCapAndLang[i]]}`;
//2
let Digit2 = document.getElementById("Digit2Id");
Digit2.innerHTML = `${keysArray[2][arrayCapAndLang[i]]}`;
//3
let Digit3 = document.getElementById("Digit3Id");
Digit3.innerHTML = `${keysArray[3][arrayCapAndLang[i]]}`;
//4
let Digit4 = document.getElementById("Digit4Id");
Digit4.innerHTML = `${keysArray[4][arrayCapAndLang[i]]}`;
//5
let Digit5 = document.getElementById("Digit5Id");
Digit5.innerHTML = `${keysArray[5][arrayCapAndLang[i]]}`;
//6
let Digit6 = document.getElementById("Digit6Id");
Digit6.innerHTML = `${keysArray[6][arrayCapAndLang[i]]}`;
//7
let Digit7 = document.getElementById("Digit7Id");
Digit7.innerHTML = `${keysArray[7][arrayCapAndLang[i]]}`;
//8
let Digit8 = document.getElementById("Digit8Id");
Digit8.innerHTML = `${keysArray[8][arrayCapAndLang[i]]}`;
//9
let Digit9 = document.getElementById("Digit9Id");
Digit9.innerHTML = `${keysArray[9][arrayCapAndLang[i]]}`;
//0
let Digit0 = document.getElementById("Digit0Id");
Digit0.innerHTML = `${keysArray[10][arrayCapAndLang[i]]}`;
//-
let Minus = document.getElementById("MinusId");
Minus.innerHTML = `${keysArray[11][arrayCapAndLang[i]]}`;
//=
let Equal = document.getElementById("EqualId");
Equal.innerHTML = `${keysArray[12][arrayCapAndLang[i]]}`;
...
//\
let Backslash = document.getElementById("BackslashId");
Backslash.innerHTML = `${keysArray[25][arrayCapAndLang[i]]}`;
